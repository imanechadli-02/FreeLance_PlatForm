    ...
    <aside class="fixed inset-y-0 left-0 w-64 bg-white shadow-lg">
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 px-4 space-y-2">
                ...
                <a href="/admin/services" class="flex items-center px-4 py-3 text-indigo-600 bg-indigo-50 rounded-lg">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 mb-6">Custom web development solutions using modern technologies and best practices.</p>
                    <div class="space-y-4">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-xl font-bold text-gray-800">UI/UX Design</h3>
                        <span class="text-2xl font-bold text-indigo-600">$2,500</span>
                    </div>
                    <p class="text-gray-600 mb-6">User-centered design solutions that create engaging and intuitive experiences.</p>
                    <div class="space-y-4">
                        <div class="flex items-center text-sm text-gray-500">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1557838923-2985c318be48?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" 
                         ...
                         class="w-full h-48 object-cover">
                    <div class="absolute top-4 right-4">
                        <span class="px-2 py-1 text-xs font-medium text-yellow-600 bg-yellow-50 rounded-full">Draft</span>
                    </div>
                </div>
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-xl font-bold text-gray-800">Digital Marketing</h3>
                        <span class="text-2xl font-bold text-indigo-600">$1,500</span>
                    </div>
                    <p class="text-gray-600 mb-6">Comprehensive digital marketing strategies to grow your online presence.</p>
                    <div class="space-y-4">
                        <div class="flex items-center text-sm text-gray-500">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
